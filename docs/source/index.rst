...
Much of the zoom-in data is stored in specialized data formats which save disk space, and are more conveint to use than traditional simulation outputs. These can be read with the :doc:`symlib <symlib>` library. This site contains full documentation for this library and many tutorials and worked examples.
