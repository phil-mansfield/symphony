...
This website contains information on these :doc:`simulations <simulations>`, :doc:`the people who ran them <credits_acknowledgements>`, :doc:`how to access the data <data_access>`, and :doc:`how to interact with the data <getting_started>`. For students, we also have a page containing :doc:`lecture notes, slides, and review papers <background_reading>` that might be helpful to understand the jargon and concepts involved with analyzing these types of simulations.
